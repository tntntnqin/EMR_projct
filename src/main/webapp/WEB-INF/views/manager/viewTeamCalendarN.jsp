...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="viewTeamCalendar">팀스케줄 관리</a>
  </li>
  <li class="nav-item">
...
<form action="teamCalendarNUpdateOK">

<table style="" align="left">

	<tr>
		<td>
			<input type="button" value="수정하기" onclick="activeSelect()"/>
	...
	<tr>
		<th>
			<c:if test="${year <= 2022}">
				...
				onclick="location.href='viewTeamCalendar?yearBA=<%=year%>&monthBA=<%=month - 1%>'">
				</c:if>
			</c:if>
			<c:if test="${year >= 2023}">
				<input class="button button1" type="button" value="이전달"
