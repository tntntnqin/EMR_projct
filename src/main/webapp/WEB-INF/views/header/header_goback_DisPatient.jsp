...
<!--  
	< 페이지 설명 >  
	페이지 최상단에 삽입되는 헤더 페이지, 로그인정보, 로그아웃버튼, 퇴원환자조회로 돌아가는 버튼
	...
	<nav class="navbar navbar-expand-lg">
		<div class="container-fluid navcon" >
			<div class="navbar-header">
				<a class="navbar-brand" onclick="location.href='viewDisPatient'">
					<img src="./images/previous.png" alt="퇴원환자 조회로 돌아가기" width="55px" align="left">
				</a>
			</div>
			<c:if test="${dpart == '의사'}">
