...
<fmt:formatDate var= "adDate" value="${patientVO.getAdDate()}" pattern="yyyy.MM.dd(E)"/>
	...
	<div style="margin-top: 20px; margin-left: 20px;">
		<form action="viewListTestMiddle">
	...
	<!-- 환자정보 (환자Tag) -->
	<div style="width: 700px; border: solid 1px; margin-top: 30px; margin-left:auto; margin-right:auto; position: relative;" align="center">
		...
		<c:if test="${viewTestList.testBloodList.size() != 0}">
			<c:forEach var="testBloodVo" items="${viewTestList.testBloodList}">
				<div style="width: 900px; border: solid 1px; padding: 10px; margin: 20px; position: relative;">
					...
					<div style="width: 400px; border: solid 1px; margin-top: 30px; margin-left: 30px; position: relative;">
						<table class="table">
							<thead>
								<tr>
					...
					<tr>
						<td align="center">
							...
							<c:forEach var="i" begin="${viewTestList.startPage}" end="${viewTestList.endPage}" step="1">
								...
								<c:if test="${viewTestList.currentPage != i}">
									<button class="button button1" type="button" onclick="location.href='viewListTestMiddle?currentPage=${i}&patientIdx=${patientIdx}&dDay=${dDay}&test=${viewTestList.test}'">
										${i}
									</button>
								</c:if>
							</c:forEach>
