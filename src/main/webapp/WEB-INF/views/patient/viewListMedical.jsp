...
<!-- (주의!!!!) 하루치 기록이 나올때 그날 해당 날짜가 나오는데, 그 날짜는 진료기록 데이터에서 가져오게 해두었다. -->
<!-- 				그래서 하루 당 진료기록이 최소 1개는 무조건 있어야함. 없으면 에러가 뜬다!!!  -->
<!-- 				실제로 하루에 진료기록이 하나도 없는경우는 없으니..  -->
<!-- 			=>	더미데이터에 모든날 최소 1개의 진료기록을 넣어야함  -->
			...
			<c:forEach var="i" begin="0" end="${view.size()-1}" step="1">
				...
				<div style="width: 800px; margin-top: 30px; margin-left: 30px; position: relative;">
					<table class="table table-bordered border-dark">
						<thead>
							<tr>
								<th colspan="6">처방내역</th>
							</tr>
						</thead>		
						<tbody>
							<tr>
								<th width="50">&nbsp;</th>
								<th width="150">처방시각</th>
								<th width="300">약명</th>
								<th>용량</th>
								<th>경로</th>
								<th>횟수</th>
