...
public class Dpart_23List {

	private ArrayList<Dpart_23VO> dpartList = new ArrayList<Dpart_23VO>();
...
//	페이징 작업에 사용할 8개의 변수를 선언한다.
	...
	public Dpart_23List(int pageSize, int totalCount, int currentPage) {
		super();
...
//	pageSize, totalCount, currentPage를 제외한 나머지 변수를 계산해서 초기화시키는 메소드
	...
	public ArrayList<Dpart_23VO> getDpartList() {
		return dpartList;
	}


	public void setDpartList(ArrayList<Dpart_23VO> dpartList) {
	...
	public String toString() {
		return "Dpart_23List [dpartList=" + dpartList + ", item=" + item + ", pageSize=" + pageSize + ", totalCount="
