...
public class Patient_1List_Item {

	private ArrayList<Patient_1VO> patient_1List_Item = new ArrayList<Patient_1VO>();
...
//	페이징 작업에 사용할 8개의 변수를 선언한다.
	...
	public Patient_1List_Item() {
	}
	
	public Patient_1List_Item(int pageSize, int totalCount, int currentPage) {
		super();
...
//	pageSize, totalCount, currentPage를 제외한 나머지 변수를 계산해서 초기화시키는 메소드
	...
	public ArrayList<Patient_1VO> getPatient_1List_Item() {
		return patient_1List_Item;
	}

	public void setPatient_1List_Item(ArrayList<Patient_1VO> patient_1List_Item) {
		this.patient_1List_Item = patient_1List_Item;
	}
	...
	public String toString() {
		return "Patient_1List_Item [patient_1List_Item=" + patient_1List_Item + ", date=" + date + ", item=" + item
